...
namespace DaggerfallWorkshop.Game.Utility
{
    ...
    public class TravelTimeCalculator
    {
        ...
        public virtual int CalculateTravelTime(DFPosition endPos,
            ...
            bool hasCart = false)
        {
            return CalculateTravelTimeFromPosition(
        ...
        /// <summary>
        /// Creates a path from an explicit starting map pixel to a destination.
        /// This is used by multiplayer party travel when the local player is inside
        /// an interior or network dungeon and PlayerGPS is not the reliable exterior anchor.
        /// </summary>
        public virtual int CalculateTravelTimeFromPosition(
            DFPosition startPos,
            DFPosition endPos,
            bool speedCautious = false,
            bool sleepModeInn = false,
            ...
            bool hasCart = false)
        {
            ...
            int playerXMapPixel = startPos.X;
            int playerYMapPixel = startPos.Y;
