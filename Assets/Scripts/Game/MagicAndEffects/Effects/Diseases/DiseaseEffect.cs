...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    public abstract class DiseaseEffect : IncumbentEffect
    {
        ...
        /// <summary>
        /// Moves this disease's daily-processing baseline to the current game day without
        /// applying any missed daily payloads. This is an explicit multiplayer load-time
        /// recovery hook; normal time progression must never call it.
        /// </summary>
        /// <returns>Previous classic game day used by this disease.</returns>
        public uint AlignLastProcessedDayToCurrentTime()
        {
            uint previousDay = lastDay;
            lastDay = DaggerfallUnity.Instance.WorldTime.DaggerfallDateTime.ToClassicDaggerfallTime() /
