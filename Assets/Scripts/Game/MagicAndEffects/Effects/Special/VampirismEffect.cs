...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    public class VampirismEffect : RacialOverrideEffect
    {
        ...
        {
            // Multiplayer vampires may start fast travel during daytime. A host still
            // advances time normally and receives the vanilla dusk-arrival adjustment; a
            // pure host-time client travels without moving the shared clock. SP is unchanged.
            if (global::TimeCatcher.IsMultiplayerSessionActive)
                return true;
