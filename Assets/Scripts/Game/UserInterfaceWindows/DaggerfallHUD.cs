...
namespace DaggerfallWorkshop.Game.UserInterfaceWindows
{
    ...
    public class DaggerfallHUD : DaggerfallBaseWindow
    {
        ...
        HUDMultiplayerParty multiplayerParty = new HUDMultiplayerParty();
        ...
        public bool ShowMultiplayerParty { get; set; }
        ...
        public HUDMultiplayerParty MultiplayerParty
        {
            get { return multiplayerParty; }
        }
        ...
        protected override void Setup()
        {
            ...
            // Use a 640x400 reference area but preserve its aspect ratio. ScaleFreely
            // stretches X and Y independently on widescreen displays and distorts faces.
            // Right/top alignment still anchors the overlay to the actual screen corner.
            multiplayerParty.Size = new Vector2(640, 400);
            multiplayerParty.AutoSize = AutoSizeModes.ScaleToFit;
            multiplayerParty.HorizontalAlignment = HorizontalAlignment.Right;
            multiplayerParty.VerticalAlignment = VerticalAlignment.Top;
            ParentPanel.Components.Add(multiplayerParty);
        ...
        public override void Update()
        {
            ...
            multiplayerParty.Enabled = ShowMultiplayerParty;
            ...
            if (!startupComplete && !GameManager.Instance.IsPlayingGame())
            {
                ...
                compass.Enabled = false;
                multiplayerParty.Enabled = false;
            }
            else
            {
