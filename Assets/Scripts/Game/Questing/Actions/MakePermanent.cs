...
namespace DaggerfallWorkshop.Game.Questing
{
    ...
    public class MakePermanent : ActionTemplate
    {
        ...
        public override void Update(Task caller)
        {
            ...
            // Convert to permanent using vanilla DFU behaviour first.
            item.MakePermanent();

            // Multiplayer / split-instance repair: a physically picked quest item can
            // exist as a different DaggerfallUnityItem instance in player inventory.
            // Report the exact MakePermanent action so QuestNetSync can permanentize
            // that carried copy locally and replicate the same transition to peers.
            // In pure single-player this only performs the local split-instance repair.
            global::QuestNetSync.ReportLocalItemMadePermanent(
