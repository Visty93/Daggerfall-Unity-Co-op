    ...
    public class PcAt : ActionTemplate
    {
        ...
        public override void Update(Task caller)
        {
            ...
            if (result)
            {
                ...
                // Multiplayer: PcAt is a local position side effect. If one player reaches
                // the final house/interior, the other player should receive the target task
                // and reward/end flow without physically entering the same place.
                if (!reportedNetworkTrigger)
                {
                    global::QuestNetSync.ReportLocalPcAtTriggered(
                        ParentQuest != null ? ParentQuest.UID : 0UL,
                        taskSymbol != null ? taskSymbol.Name : string.Empty,
                        textId);
                    reportedNetworkTrigger = true;
                }
            }
            else
            {
        ...
        public struct SaveData_v1
        {
            ...
            public bool reportedNetworkTrigger;
            // Place type parameters
            public int p2;
            public int p3;
        }
        ...
        public override object GetSaveData()
        {
            ...
            data.reportedNetworkTrigger = false; // runtime-only: do not persist network guard across save/load
            data.p2 = p2;
            data.p3 = p3;
        ...
        public override void RestoreSaveData(object dataIn)
        {
            ...
            reportedNetworkTrigger = false; // runtime-only: stale true here breaks reload-before-finish
            p2 = data.p2;
            p3 = data.p3;
        }
