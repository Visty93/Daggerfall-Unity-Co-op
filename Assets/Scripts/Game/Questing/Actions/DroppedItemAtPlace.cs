    ...
    public class DroppedItemAtPlace : ActionTemplate
    {
        ...
        public override bool CheckTrigger(Task caller)
        {
            ...
            if (item.PlayerDropped)
            {
                ...
                // Multiplayer: replicate this quest drop as a quest side-effect, not as
                // a physical dropped-object sync. The source already verified item+place.
                try
                {
                    global::QuestNetSync.ReportLocalDroppedItemAtPlace(
