    ...
    public class ItemUsedDo : ActionTemplate
    {
        ...
        public override void Update(Task caller)
        {
            ...
            if (item.UseClicked)
            {
                ...
                // Multiplayer: UseClicked is local inventory input and does not exist on
                // the host when a pure client uses this quest item. Replicate the exact
                // validated ItemUsedDo edge rather than waiting for routine task snapshots.
                global::QuestNetSync.ReportLocalItemUsedDo(
                    ParentQuest.UID,
