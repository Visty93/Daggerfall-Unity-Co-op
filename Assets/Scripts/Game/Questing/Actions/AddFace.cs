...
namespace DaggerfallWorkshop.Game.Questing.Actions
{
    ...
    public class AddFace : ActionTemplate
    {
        ...
        public override void Update(Task caller)
        {
            ...
            // This is a local HUD side effect. It should not directly send its own
            // network event; the Person click replay in QuestNetSync is what makes
            // the remote quest tick reach this action. Sending both the click and
            // the face caused duplicate faces/popups.
