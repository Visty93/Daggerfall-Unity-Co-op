...
namespace DaggerfallWorkshop.Game.Questing
{
    ...
    public class RevealLocation : ActionTemplate
    {
        ...
        public override void Update(Task caller)
        {
            ...
            // Multiplayer: discovering a location is a local PlayerGPS side effect, not normal quest state.
            // Replicate it directly so the other player sees the dungeon on the travel map too.
            global::QuestNetSync.ReportLocalLocationRevealed(
                ParentQuest != null ? ParentQuest.UID : 0UL,
                placeSymbol != null ? placeSymbol.Name : string.Empty,
                readMap);
