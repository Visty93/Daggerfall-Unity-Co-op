...
namespace DaggerfallWorkshop.Game.Questing
{
    ...
    public class Item : QuestResource
    {
        ...
        /// <summary>
        /// Rebinds this virtual quest Item to the physical inventory instance that now
        /// represents it. Used when multiplayer pickup needs to clone a placed world item.
        /// Keeping the resource and inventory object identical preserves vanilla follow-up
        /// actions such as HaveItem and MakePermanent.
        /// </summary>
        internal void RebindDaggerfallUnityItem(DaggerfallUnityItem replacement)
        {
            if (replacement == null)
                return;
            ...
            // Permanence is monotonic. If this virtual item was already made permanent
            // before a late rebind, the replacement must inherit that state too.
            if (madePermanent)
                item.MakePermanent();
        }
