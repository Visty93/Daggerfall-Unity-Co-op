...
namespace DaggerfallWorkshop
{
    ...
    public class DaggerfallActionDoor : MonoBehaviour
    {
        ...
        public void ToggleDoor(bool activatedByPlayer = false)
        {
            ...
            ActionState stateBefore = currentState;
            ...
            // Captures both player and enemy door use. DoorsCatcher is a no-op in SP and
            // suppresses this callback while applying a remote door/action event.
            DoorsCatcher.NotifyDoorActivated(
                this,
                originalPosition,
                stateBefore,
                activatedByPlayer);
