...
namespace DaggerfallWorkshop.Utility
{
    ...
    public static class RDBLayout
    {
            ...
            int waterLevel = 10000)
        {
            ...
            if (setupEnemy != null)
            {
                // In multiplayer, resolve Unspecified once on the server before the enemy
                // billboard/entity is built. In single-player this returns the original value.
                gender = GameObjectHelper.ResolveDungeonEnemyGenderForNetwork(gender);
