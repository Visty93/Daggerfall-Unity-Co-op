...
namespace DaggerfallWorkshop.Utility
{
    ...
    public static class RandomEncounters
    {
        ...
        public static MobileTypes ChooseRandomEnemy(bool chooseUnderWaterEnemy, int playerLevelOverride = -1)
        {
            ...
            int playerLevel = playerLevelOverride > 0
                ? Math.Max(1, Math.Min(100, playerLevelOverride))
                : Game.GameManager.Instance.PlayerEntity.Level;
            int min;
            int max;
